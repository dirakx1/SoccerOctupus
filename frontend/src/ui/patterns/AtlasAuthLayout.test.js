...
describe('AtlasAuthLayout', () => {
  it('keeps the competition-neutral match intelligence composition decorative and exposes both content slots', () => {
    ...
    expect(wrapper.find('.analysis-card-score').text()).toContain('Match intelligence')
    expect(wrapper.find('.analysis-card-score').text()).toContain('Form, tactics and market signals')
    expect(wrapper.find('.analysis-card-stat').text()).toContain('Five-agent model')
    expect(wrapper.find('.analysis-card-stat').text()).toContain('One signal')
    expect(wrapper.find('.analysis-card-stat').text()).toContain('Every competition. Every match.')
